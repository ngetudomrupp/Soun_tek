        ...
        <div class="container">
          ...
          <h3 class="text-center mb-1">
            <span class="position-relative fw-bold z-1"
              >Let's work
              <img
                src="<?= $db->base_url(); ?>/assets/img/front-pages/icons/section-title-icon.png"
                alt="laptop charging"
          ...
          <div class="row gy-4">
            <div class="col-lg-5">
              <div class="contact-img-box position-relative border p-2 h-100">
                <img
                  src="<?= $db->base_url(); ?>/assets/img/front-pages/icons/contact-border.png"
                  alt="contact border"
                  class="contact-border-img position-absolute d-none d-md-block scaleX-n1-rtl" />
                <img
                  src="<?= $db->base_url(); ?>/assets/img/front-pages/landing-page/contact-customer-service.png"
